...
![image-20240705144248581](C:\Users\123\AppData\Roaming\Typora\typora-user-images\image-20240705144248581.png)
...
![image-20240705150124314](C:\Users\123\AppData\Roaming\Typora\typora-user-images\image-20240705150124314.png)

Deepcom整体的模型基于Seq2Seq模型来学习源代码并生成注释，该模型由三个组件组成，一个编码器、一个解码器和一个注意力组件，其中编码器和解码器都是LSTM。

![image-20240705151401920](C:\Users\123\AppData\Roaming\Typora\typora-user-images\image-20240705151401920.png)

对语法树进行普通的前序遍历生成的序列无法完整包含语法树所含有的信息，具有二义性；DeepCom采用基于结构的遍历方法产生模型输入序列，消除了二义性，使代码摘要生成的结果更为精准。

![image-20240705150544499](C:\Users\123\AppData\Roaming\Typora\typora-user-images\image-20240705150544499.png)
...
![image-20240705152448663](C:\Users\123\AppData\Roaming\Typora\typora-user-images\image-20240705152448663.png)
...
![image-20240705153625488](C:\Users\123\AppData\Roaming\Typora\typora-user-images\image-20240705153625488.png)

获取目标函数的源代码，并使用编码器进行总结：

![image-20240705171506154](C:\Users\123\AppData\Roaming\Typora\typora-user-images\image-20240705171506154.png)
...
![image-20240705180043748](C:\Users\123\AppData\Roaming\Typora\typora-user-images\image-20240705180043748.png)
...
![image-20240705181627166](C:\Users\123\AppData\Roaming\Typora\typora-user-images\image-20240705181627166.png)
